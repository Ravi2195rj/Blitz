...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0x37138276 (decimal 924025462)
	set	_packageName,r2
	set	0x37138276,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_bufferLock
	set	_Global_bufferLock,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_bufferContent
	set	_Global_bufferContent,r1
	store	r1,[r14+-212]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_bufferSpaceLeft
	set	_Global_bufferSpaceLeft,r1
	store	r1,[r14+-208]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_426 = &_Global_bufferSpaceLeft
	set	_Global_bufferSpaceLeft,r1
	store	r1,[r14+-40]
!   Send message Down
	load	[r14+-40],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_431 = &_Global_bufferContent
	set	_Global_bufferContent,r1
	store	r1,[r14+-20]
!   Send message Up
	load	[r14+-20],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_451 = &_Global_bufferContent
	set	_Global_bufferContent,r1
	store	r1,[r14+-40]
!   Send message Down
	load	[r14+-40],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_456 = &_Global_bufferSpaceLeft
	set	_Global_bufferSpaceLeft,r1
	store	r1,[r14+-20]
!   Send message Up
	load	[r14+-20],r1
...
!   _temp_615 = 4		(4 bytes)
	...
	store	r1,[r14+-28]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_614  (sizeInBytes=4)
	load	[r14+-32],r1
	store	r1,[r14+-196]
_Label_610:
!   Perform the FOR-LOOP termination test
!   if i > _temp_615 then goto _Label_613		
	load	[r14+-196],r1
	load	[r14+-28],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_650 = _temp_651 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-96]
!   Move address of _temp_649 [_temp_650 ] into _temp_652
!     make sure index expr is >= 0
	load	[r14+-96],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_648 = *_temp_652  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-104]
!   if _temp_648 == 2 then goto _Label_646		(int)
	load	[r14+-104],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_646
...
!   _temp_657 = p - 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-68]
!   _temp_656 = _temp_657 + 5		(int)
	load	[r14+-68],r1
	mov	5,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-72]
!   _temp_655 = _temp_656 rem 5		(int)
	load	[r14+-72],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-76]
!   Move address of _temp_654 [_temp_655 ] into _temp_658
!     make sure index expr is >= 0
	load	[r14+-76],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-64]
!   Data Move: _temp_653 = *_temp_658  (sizeInBytes=4)
	load	[r14+-64],r1
	load	[r1],r1
	store	r1,[r14+-84]
!   if _temp_653 == 2 then goto _Label_646		(int)
	load	[r14+-84],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_646
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_662 = &monitorLock
	load	[r14+8],r1
	add	r1,28,r1
	store	r1,[r14+-48]
!   _temp_663 = &startEating
	load	[r14+8],r1
	add	r1,56,r1
	store	r1,[r14+-44]
...
!   _temp_668 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_668 [p ] into _temp_669
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_667 = *_temp_669  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-36]
!   if _temp_667 == 2 then goto _Label_666		(int)
	load	[r14+-36],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_666
...
! SEND STATEMENT...
	mov	553,r13		! source line 553
	mov	"\0\0SE",r10
!   _temp_670 = &monitorLock
	load	[r14+8],r1
	add	r1,28,r1
	store	r1,[r14+-24]
!   _temp_671 = &startEating
	load	[r14+8],r1
	add	r1,56,r1
	store	r1,[r14+-20]
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-184]
!   Data Move: *_temp_707 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-184],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_714 = _temp_715 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-168]
!   Move address of _temp_713 [_temp_714 ] into _temp_716
!     make sure index expr is >= 0
	load	[r14+-168],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_712 = *_temp_716  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-176]
!   if _temp_712 == 2 then goto _Label_710		(int)
	load	[r14+-176],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_710
...
!   _temp_719 = p rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-148]
!   Move address of _temp_718 [_temp_719 ] into _temp_720
!     make sure index expr is >= 0
	load	[r14+-148],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-144]
!   Data Move: _temp_717 = *_temp_720  (sizeInBytes=4)
	load	[r14+-144],r1
	load	[r1],r1
	store	r1,[r14+-156]
!   if _temp_717 == 2 then goto _Label_710		(int)
	load	[r14+-156],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_710
...
!   _temp_722 = _temp_723 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-136]
!   Move address of _temp_721 [_temp_722 ] into _temp_724
!     make sure index expr is >= 0
	load	[r14+-136],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_738 = p - 2		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-84]
!   _temp_737 = _temp_738 + 5		(int)
	load	[r14+-84],r1
	mov	5,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-88]
!   _temp_736 = _temp_737 rem 5		(int)
	load	[r14+-88],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-92]
!   Move address of _temp_735 [_temp_736 ] into _temp_739
!     make sure index expr is >= 0
	load	[r14+-92],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-80]
!   Data Move: _temp_734 = *_temp_739  (sizeInBytes=4)
	load	[r14+-80],r1
	load	[r1],r1
	store	r1,[r14+-100]
!   if _temp_734 == 2 then goto _Label_732		(int)
	load	[r14+-100],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_732
...
!   _temp_742 = p rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-68]
!   Move address of _temp_741 [_temp_742 ] into _temp_743
!     make sure index expr is >= 0
	load	[r14+-68],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_740 = *_temp_743  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-76]
!   if _temp_740 == 2 then goto _Label_732		(int)
	load	[r14+-76],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_732
...
!   _temp_747 = p - 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-48]
!   _temp_746 = _temp_747 + 5		(int)
	load	[r14+-48],r1
	mov	5,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-52]
!   _temp_745 = _temp_746 rem 5		(int)
	load	[r14+-52],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-56]
!   Move address of _temp_744 [_temp_745 ] into _temp_748
!     make sure index expr is >= 0
	load	[r14+-56],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_750 = &monitorLock
	load	[r14+8],r1
	add	r1,28,r1
	store	r1,[r14+-36]
!   _temp_751 = &startEating
	load	[r14+8],r1
	add	r1,56,r1
	store	r1,[r14+-32]
!   _temp_754 = p - 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-20]
!   _temp_753 = _temp_754 + 5		(int)
	load	[r14+-20],r1
	mov	5,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _temp_752 = _temp_753 rem 5		(int)
	load	[r14+-24],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-28]
!   Move address of _temp_751 [_temp_752 ] into _temp_755
!     make sure index expr is >= 0
	load	[r14+-28],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_811 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_810  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_806:
!   Perform the FOR-LOOP termination test
!   if p > _temp_811 then goto _Label_809		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_818 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_818 [p ] into _temp_819
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
